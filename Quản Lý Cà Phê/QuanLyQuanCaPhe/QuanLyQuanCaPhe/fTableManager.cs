...
namespace QuanLyQuanCaPhe
{
    public partial class fTableManager : Form
    {
        ...
        private void btnSwitchTable_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format("Bạn có thật sự muốn chuyên bàn {0} qua bàn {1}", (lsvBill.Tag as Table).Name, (cbSwitchTable.SelectedItem as Table).Name), "Thông báo", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.OK)
