...
namespace QuanLyQuanCaPhe
{
    public partial class fAdmin : Form
    {
        ...
        void LoadAccountList()
        {
            ...
            dtgvAccount.DataSource = DataProvider.Instance.ExecuteQuery(query, new object[] { "nhatping" });
        }
        ...
        void DeleteAccount(string userName)
        {
            ...
            {
                MessageBox.Show("Vui lòng không xóa tài khoản đang dùng!");
                return;
            }
        ...
        private void txbFoodID_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (dtgvFood.SelectedCells.Count > 0)
                {
                    ...
                    cbFoodCategory.SelectedItem = index;
                }
            }
            catch { }
        }
        ...
        {
            int sumRecord = BillDAO.Instance.GetNumBillListByDate(dtpkFromDate1.Value, dtpkToDate1.Value);
        ...
        {
            dtgvBill1.DataSource = BillDAO.Instance.GetBillListByDateAndPage(dtpkFromDate1.Value, dtpkToDate1.Value, Convert.ToInt32(txbPageBill.Text));
